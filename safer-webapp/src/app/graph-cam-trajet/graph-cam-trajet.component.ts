...
@Component({
  selector: 'app-graph-cam-trajet',
  templateUrl: './graph-cam-trajet.component.html',
  styleUrls: ['./graph-cam-trajet.component.css'],
})
export class GraphCamTrajetComponent {
  ...
  fetchData(): void {
    this.crashService.getAccidentsByUniqueValues('trajet').subscribe((data) => {
