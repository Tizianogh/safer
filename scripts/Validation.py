...
cross_val_scores = cross_val_score(rf, X, y, cv=5).mean()
...
print(f"Random Forest Cross-Validation Score: {cross_val_scores}\n")
print(f"Random Forest F1 Score: {f1_score}\n")
print(f"Random Forest Precision: {precision_score}\n")
print(f"Random Forest Recall: {recall_score}\n\n")
